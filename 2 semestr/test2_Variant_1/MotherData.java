...
public class MotherData {
    ...
    public MotherData(char gender, byte plural, byte age, String race, byte parity, boolean married, short birthWeight, byte smokeN, byte drinkN, boolean firstep, boolean welfare, boolean smoker, boolean drinker, short wpre, short wgain, byte education, byte gestation) {
        this.gender = gender;
        this.plural = plural;
        this.age = age;
        this.race = race;
